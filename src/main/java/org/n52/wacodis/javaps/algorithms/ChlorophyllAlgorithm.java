 ...
 */
@Algorithm(
        identifier = "de.hsbo.wacodis.chlorophyll",
        title = "Chlorophyll Index",
        abstrakt = "Perform a Chlorophyll Index calculation.",
        version = "1.0.0",
        storeSupported = true,
        statusSupported = true)
public class ChlorophyllAlgorithm extends AbstractAlgorithm {

    private static final String PROCESS_ID = "de.hsbo.wacodis.chlorophyll";
    private static final String RESULTNAMEPREFIX = "chlorophyll_result";
    private static final String TOOL_CONFIG = "chlorophyll.yml";

    private static final Logger LOGGER = LoggerFactory.getLogger(ChlorophyllAlgorithm.class);
